...
class Tilemap < RGSS::Tilemap3
  ...
  def initialize(viewport=nil)
    ...
    #@ox = 0
    #@oy = 0
    #@layers[0].z = 0   # soil           -- layer 0
    #
    #@layers[1].z = 50  # soil objects   -- layer 1
    #@layers[2].z = 100 # upper layer    -- layer 2
    #@layers[3].z = 250 # upper layer 2  -- layer 2 & over_tile
    #
  ...
  def get_bitmap(id, frame=0)
    ...
    bmp.entity.setBlendMode(SDL::BLENDMODE_NONE)
    if id < 1024 # B-E
      sub_id = id % 256
      case id / 256
        when 0 # B
      ...
      tilemap.entity.setBlendMode(SDL::BLENDMODE_NONE)
      if sub_id < 128
  ...
  def draw
    ...
    draw_region if @changed
    @changed = false

    # Draw Region
    draw_current_region unless @changed
